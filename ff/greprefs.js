...
pref("browser.cache.compression_level",0);pref("browser.download.forbid_open_with",false);pref("dom.registerContentHandler.enabled",false);pref("dom.registerProtocolHandler.insecure.enabled",false);pref("dom.quotaManager.testing",false);pref("dom.indexedDB.enabled",true);pref("dom.indexedDB.experimental",false);pref("dom.indexedDB.logging.enabled",true);pref("dom.indexedDB.logging.details",true);pref("dom.indexedDB.logging.profiler-marks",false);pref("dom.indexedDB.storageOption.enabled",false);pref("dom.fileHandle.enabled",true);pref("dom.manifest.onappinstalled",false);pref("dom.select_events.enabled",true);
pref("dom.select_events.textcontrols.enabled",false);pref("dom.workers.maxPerDomain",512);pref("dom.serviceWorkers.enabled",false);pref("dom.serviceWorkers.idle_timeout",30000);pref("dom.serviceWorkers.idle_extended_timeout",300000);
pref("dom.serviceWorkers.update_delay",1000);pref("dom.serviceWorkers.testUpdateOverOneDay",false);pref("dom.enable_performance",true);pref("dom.enable_resource_timing",true);pref("dom.enable_performance_navigation_timing",true);pref("dom.performance.enable_user_timing_logging",false);pref("dom.performance.enable_notify_performance_timing",false);pref("dom.performance.enable_scheduler_timing",false);pref("dom.permissions.revoke.enable",false);pref("dom.performance.time_to_non_blank_paint.enabled",false);pref("dom.performance.time_to_dom_content_flushed.enabled",false);pref("dom.enable_performance_observer",true);pref("dom.requestIdleCallback.enabled",true);
...
pref("media.peerconnection.turn.disable",false);pref("media.getusermedia.aec_enabled",true);pref("media.getusermedia.noise_enabled",true);pref("media.getusermedia.aec_extended_filter",true);pref("media.getusermedia.noise",1);pref("media.getusermedia.agc_enabled",false);pref("media.getusermedia.agc",3);
...
pref("media.cubeb.sandbox",true);pref("media.audioipc.pool_size",2);pref("media.audioipc.stack_size",262144);pref("media.webaudio.audiocontextoptions-samplerate.enabled",true);
...
pref("toolkit.asyncshutdown.log",false);pref("browser.dom.window.dump.enabled",false,sticky);pref("toolkit.dump.emit",false);pref("view_source.syntax_highlight",true);pref("view_source.wrap_long_lines",false);pref("view_source.editor.path","");
...
pref("editor.resizing.enabled_by_default",true);pref("editor.inline_table_editing.enabled_by_default",true);pref("editor.positioning.enabled_by_default",true);
...
pref("privacy.firstparty.isolate.restrict_opener_access",true);pref("privacy.resistFingerprinting",false);
...
pref("network.sts.pollable_event_timeout",6);pref("network.websocket.max-message-size",2147483647);pref("network.websocket.auto-follow-http-redirects",false);pref("network.websocket.timeout.open",20);
...
pref("network.http.tailing.delay-max",6000);pref("network.http.tailing.total-max",45000);pref("permissions.default.image",1);pref("network.proxy.type",5);pref("network.proxy.ftp","");pref("network.proxy.ftp_port",0);pref("network.proxy.http","");pref("network.proxy.http_port",0);pref("network.proxy.ssl","");pref("network.proxy.ssl_port",0);pref("network.proxy.socks","");pref("network.proxy.socks_port",0);pref("network.proxy.socks_version",5);pref("network.proxy.socks_remote_dns",false);pref("network.proxy.proxy_over_tls",true);pref("network.proxy.no_proxies_on","localhost, 127.0.0.1");pref("network.proxy.failover_timeout",1800);pref("network.online",true);pref("network.cookie.thirdparty.sessionOnly",false);pref("network.cookie.thirdparty.nonsecureSessionOnly",false);pref("network.cookie.leave-secure-alone",true);pref("network.cookie.same-site.enabled",true);pref("network.cookie.ipc.sync",false);
...
pref("layout.css.devPixelsPerPx","-1.0");pref("layout.css.individual-transform.enabled",false);pref("layout.css.initial-letter.enabled",false);pref("layout.css.mix-blend-mode.enabled",true);pref("layout.css.isolation.enabled",true);pref("layout.css.filters.enabled",true);pref("layout.css.scrollbar-colors.enabled",false);pref("layout.css.scrollbar-width.enabled",false);
...
pref("layout.display-list.retain",false);pref("layout.display-list.retain.chrome",false);
...
pref("image.cache.factor2.threshold-surfaces",4);pref("image.cache.size",5242880);pref("image.cache.timeweight",500);pref("image.decode-immediately.enabled",false);pref("image.downscale-during-decode.enabled",true);pref("image.http.accept","*/*");

pref("image.infer-src-animation.threshold-ms",2000);
pref("image.layout_network_priority",true);

pref("image.mem.discardable",true);
pref("image.mem.animated.discardable",true);pref("image.mem.animated.use_heap",true);
...
pref("extensions.webextensions.protocol.remote",true);pref("extensions.webextensions.tabhide.enabled",true);pref("extensions.webextensions.background-delayed-startup",false);pref("extensions.webextensions.ExtensionStorageIDB.enabled",false);pref("extensions.webextensions.enablePerformanceCounters",false);pref("extensions.webcompat-reporter.newIssueEndpoint","https://webcompat.com/issues/new");pref("extensions.webcompat-reporter.enabled",false);pref("network.buffer.cache.count",24);pref("network.buffer.cache.size",32768);pref("dom.webnotifications.enabled",true);pref("dom.webnotifications.serviceworker.enabled",true);pref("dom.webnotifications.requireinteraction.count",3);pref("dom.webnotifications.requireinteraction.enabled",false);pref("alerts.showFavicons",false);
...
pref("pointer-lock-api.warning.timeout",3000);pref("dom.event.handling-user-input-time-limit",1000);pref("layout.animated-image-layers.enabled",false);pref("dom.vibrator.enabled",true);pref("dom.vibrator.max_vibrate_ms",10000);pref("dom.vibrator.max_vibrate_list_len",128);pref("dom.battery.enabled",true);pref("dom.streams.enabled",false);pref("dom.push.enabled",false);pref("dom.push.alwaysConnect",false);pref("dom.push.loglevel","Error");pref("dom.push.serverURL","wss://push.services.mozilla.com/");pref("dom.push.userAgentID","");
...
pref("dom.promise_rejection_events.enabled",false);pref("dom.imagecapture.enabled",false);pref("media.ondevicechange.enabled",true);pref("media.ondevicechange.fakeDeviceChangeEvent.enabled",false);



pref("layout.css.touch_action.enabled",true);pref("dom.netinfo.enabled",true);
...
pref("dom.vr.display.rafMaxDuration",50);pref("dom.vr.test.enabled",false);pref("dom.vr.service.enabled",false);
...
pref("layout.accessiblecaret.enabled_on_touch",true);pref("layout.accessiblecaret.width","34.0");pref("layout.accessiblecaret.height","36.0");pref("layout.accessiblecaret.margin-left","-18.5");pref("layout.accessiblecaret.caret_shown_when_long_tapping_on_empty_content",false);
pref("layout.accessiblecaret.use_long_tap_injector",false);pref("layout.accessiblecaret.always_tilt",false);pref("layout.accessiblecaret.script_change_update_mode",0);pref("layout.accessiblecaret.allow_dragging_across_other_caret",true);pref("layout.accessiblecaret.hapticfeedback",false);pref("layout.accessiblecaret.extend_selection_for_phone_number",false);pref("layout.accessiblecaret.hide_carets_for_mouse_input",true);pref("dom.wakelock.enabled",false);pref("identity.fxaccounts.auth.uri","https://api.accounts.firefox.com/v1");pref("beacon.enabled",true);pref("dom.caches.enabled",true);pref("dom.udpsocket.enabled",false);pref("dom.presentation.enabled",false);pref("dom.presentation.controller.enabled",false);pref("dom.presentation.receiver.enabled",false);pref("dom.presentation.tcp_server.debug",false);pref("dom.presentation.discovery.enabled",false);pref("dom.presentation.discovery.timeout_ms",10000);pref("dom.presentation.discoverable",false);pref("dom.presentation.discoverable.encrypted",true);pref("dom.presentation.discoverable.retry_ms",5000);pref("dom.presentation.session_transport.data_channel.enable",false);pref("dom.meta-viewport.enabled",false);pref("dom.visualviewport.enabled",false);pref("browser.search.log",false);pref("browser.search.update",true);pref("browser.search.update.log",false);pref("browser.search.update.interval",21600);pref("browser.search.suggest.enabled",true);pref("browser.search.reset.enabled",false);pref("browser.search.reset.whitelist","");pref("browser.search.geoSpecificDefaults",false);pref("browser.search.geoip.url","https://location.services.mozilla.com/v1/country?key=%MOZILLA_API_KEY%");pref("browser.search.geoip.timeout",3000);
...
pref("dom.timeout.max_consecutive_callbacks_ms",4);pref("dom.payments.request.enabled",false);pref("dom.payments.loglevel","Warn");pref("dom.payments.defaults.saveCreditCard",false);pref("dom.payments.defaults.saveAddress",true);pref("dom.xhr.lowercase_header.enabled",false);
...
pref("browser.fastblock.limit",0);pref("dom.events.asyncClipboard",true);pref("dom.events.asyncClipboard.dataTransfer",false);pref("dom.events.testing.asyncClipboard",false);pref("dom.datatransfer.mozAtAPIs",true);
